...
function clickedAbout() {
    ...
    if (window.matchMedia("(max-width: 768px)").matches) {
        ...
        document.getElementById("lowes").innerHTML = 
        "<div style='min-height: calc(100vh - 10rem); display: grid; place-items: center;'><button disabled type='button' class='lbutton lbutton--loading' onclick='this.classList.toggle('lbutton--loading')'><span class='button__text'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></button></div>"
